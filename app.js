...
//获取static静态资源文件_koa-static-server模板接口
var koa_static = require('koa-static-server');
//配置获取静态资源文件api
app.use(koa_static({
	rootDir : './static',  /*文件系统目录，./为当前目录*/
	rootPath : '/static',  /*URL访问静态文件的地址*/
	maxage : 0,            /*制定过期时间，测试时设置为0，即不缓存*/
}));

//获取Mock数据接口-service模块接口
...
app.use(controller.get('/book',function*(){
	...
	this.body = yield render('book',{nav:'书城详情',bookId:bookId});
}));
...
app.listen(3001);
console.log('koa server is start');
